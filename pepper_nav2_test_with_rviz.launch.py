...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('params_file', default_value='/mnt/data/pepper_nav2_params.yaml'),
        DeclareLaunchArgument('rviz_config', default_value='/mnt/data/pepper_nav_test.rviz'),
        ...
        ExecuteProcess(
            cmd=[
                'python3',
                '/mnt/data/pepper_platform_nav_nav2_action.py',
                '--ros-args',
